import AvatarWithRipple2 from '@/components/server-components/avatarripple2';
import AvatarWithRipple3 from '@/components/server-components/avatarripple3';
            ...
            <div className="ml-16 fixed top-[19%] z-10">
              <div className="flex space-x-4">
                <div className="relative inline-block text-center">
                  ...
                  <button className="m-2 bg-blue-600 text-white rounded px-2">FAQ</button>
